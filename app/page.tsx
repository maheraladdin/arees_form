    ...
    return (
        <main>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mx-auto p-4 w-full max-w-[400px]">
                <h1 className="text-4xl font-bold text-center">Add Program</h1>
                ...
                <fieldset>
                    <label htmlFor={"image"} className={"mb-2"}>Program URL</label>
                    <input {...register("listing_url")} placeholder="URL for the program"
                ...
                <fieldset>
                    <label htmlFor={"image"} className={"mb-2"}>Add program image</label>
                    <UploadDropzone
                ...
                <fieldset>
                    <label htmlFor={"room_type"} className={"mb-2"}>Program type</label>
                    <select id={"room_type"} {...register("room_type")}
                        ...
                        {Array.from(Object.values(RoomType)).map((roomType) => (
